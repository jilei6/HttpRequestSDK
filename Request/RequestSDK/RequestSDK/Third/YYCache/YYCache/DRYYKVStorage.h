 ...
 */
@interface DRYYKVStorageItem : NSObject
 ...
 */
typedef NS_ENUM(NSUInteger, DRYYKVStorageType) {
    
    /// The `value` is stored as a file in file system.
    DRYYKVStorageTypeFile = 0,
    
    /// The `value` is stored in sqlite with blob type.
    DRYYKVStorageTypeSQLite = 1,
    
    /// The `value` is stored in file system or sqlite based on your choice.
    DRYYKVStorageTypeMixed = 2,
};
 ...
 */
@interface DRYYKVStorage : NSObject
...
@property (nonatomic, readonly) DRYYKVStorageType type;  ///< The type of this storage.
 ...
 */
- (instancetype)initWithPath:(NSString *)path type:(DRYYKVStorageType)type NS_DESIGNATED_INITIALIZER;
