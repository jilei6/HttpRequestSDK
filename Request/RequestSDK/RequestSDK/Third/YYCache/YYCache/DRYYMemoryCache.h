 ...
 */
@interface DRYYMemoryCache : NSObject
 ...
 */
@property (copy) void(^didReceiveMemoryWarningBlock)(DRYYMemoryCache *cache);

/**
 A block to be executed when the app enter background.
 The default value is nil.
 */
@property (copy) void(^didEnterBackgroundBlock)(DRYYMemoryCache *cache);
